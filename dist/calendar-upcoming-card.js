...
let CalendarUpcomingCardEditor = class CalendarUpcomingCardEditor extends i {
    setConfig(config) {
        this.config = config;
    }
    getCalendarEntities() {
...
__decorate([
    n({ attribute: false })
], CalendarUpcomingCardEditor.prototype, "hass", void 0);
__decorate([
    r$1()
], CalendarUpcomingCardEditor.prototype, "config", void 0);
CalendarUpcomingCardEditor = __decorate([
    t$1('calendar-upcoming-card-editor')
], CalendarUpcomingCardEditor);

let CalendarUpcomingCard = class CalendarUpcomingCard extends i {
    constructor() {
        super(...arguments);
        this.events = [];
    }
    ...
    render() {
      ...
      `;
        ...
        <ha-card>
          ${this.config.title
                ? x `<h1 class="card-header">${this.config.title}</h1>`
                : ''}
          <div class="card-content">
      ...
      <div class="card-container ${layout}">
        ...
        ${this.events.map((event) => {
            ...
            return x `
            <ha-card class="event-card ${eventClass}">
    ...
    static get styles() {
      ...
      ha-card.event-card.ongoing {
        border-left-color: #ff9800;
      }

      ha-card.event-card.past {
...
__decorate([
    n({ attribute: false })
], CalendarUpcomingCard.prototype, "hass", void 0);
__decorate([
    r$1()
], CalendarUpcomingCard.prototype, "config", void 0);
__decorate([
    r$1()
], CalendarUpcomingCard.prototype, "events", void 0);
CalendarUpcomingCard = __decorate([
    t$1('calendar-upcoming-card')
...
//# sourceMappingURL=calendar-upcoming-card.js.map
